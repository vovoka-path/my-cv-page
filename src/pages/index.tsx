...
import heroImageLink from '../static/deco-line-light2.png';
import Button from '@mui/material/Button';
import { COLOR } from '../data/constants';
import Theme1 from '../components/Theme1';

const title = 'About';
// const heroImageLink = '/deco-line-light2.png';
// const heroImageLink = '../images/deco-line-light2.png';
// const heroImageLink = '../../deco-line-light2.png';
...
const parentStyles = {
  width: '100%',
  height: '100%',
  // backgroundImage: 'linear-gradient(30deg, #673AB7 50%, #00BCD4 140%)',
  backgroundImage: 'linear-gradient(30deg, #2196F3 50%, #00BCD4 140%)',
};
...
const styles2 = {
  ...
  position: 'absolute',
  transform: 'none',
  background: `url(${heroImageLink}) no-repeat 0 0`,
  ...
  return (
    <Layout>
      <Container maxWidth="lg">
        ...
        {/* <ExampleText /> */}
        <Box component="div" sx={parentParentStyles}>
          <Box component="div" sx={parentStyles}>
            <Box component="div" sx={styles1}></Box>
            <Box component="div" sx={styles2}></Box>
          </Box>
        </Box>
      </Container>
    </Layout>
