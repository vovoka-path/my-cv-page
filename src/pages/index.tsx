...
import heroBGImageLink from '../static/deco-line-light2.png';
...
const styles2 = {
  ...
  position: 'absolute',
  transform: 'none',
  background: `url(${heroBGImageLink}) no-repeat 0 0`,
  ...
  return (
    <Layout>
      <Container maxWidth="lg">
        ...
        {/* <ExampleText /> */}
        <Box component="div" sx={parentParentStyles} height={{ xs: '260px', md: '716px' }}>
          <Box component="div" sx={parentStyles}>
            <Box
              component="div"
              sx={{
                ...styles1,
                backgroundSize: { xs: '100% 260px', md: '100% 716px' },
              }}
            ></Box>
            <Box
              component="div"
